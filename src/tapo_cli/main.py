...
GUIDE = """\033[1;36m
  ...
  \033[1m4. Usage\033[0m
     ...
     \033[33mtapo view <cam>\033[0m               Live stream
     ...
     \033[33mtapo setup\033[0m                    Run setup wizard again
...
def _discover_cameras():
    ...
    # Try connecting to port 554 (RTSP) on each host — Tapo cameras listen here
    found = []
...
def cmd_setup(args):
    ...
    # Let user name discovered cameras and add manual ones
    ...
    if not cameras:
        print("\n  \033[33mNo cameras configured. Run 'tapo setup' again later.\033[0m")
        return
    ...
    print(f"\n  Try: \033[33mtapo status {list(cameras.keys())[0]}\033[0m\n")
